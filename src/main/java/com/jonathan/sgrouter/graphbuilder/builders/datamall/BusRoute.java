...
public class BusRoute {
	...
	public BusRoute(String src, double distance, String WD_first, String WD_last, String SAT_first, String SAT_last,String SUN_first,  String SUN_last){
		this.src=src;
	...
	public String toString(){
		return String.format("%s (%f): %s %s %s %s",src,distance,WD_first,WD_last,SAT_first,SAT_last,SUN_first,SUN_last);
	}
}
